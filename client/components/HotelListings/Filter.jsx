        ...
        <div className='flex flex-col justify-betweem items-start gap-5 w-[290px] h-[1322px]'>
          <div className='flex flex-col gap-[30px]'>
            ...
            <div className='flex flex-col justify-between items-start gap-[15px]'>
              ...
              <div className='flex flex-row justify-between items-center gap-3'>
                ...
                <svg
                  ...
                  className='absolute left-[223px] pointer-events-none'
                >
                  <path
            ...
            <div>
              <label
                for='price-range'
                className='text-sidebar text-body-18 block mb-2'
              >
                Price range
              </label>
              <input
                ...
                min='50'
                max='200'
                class='w-full h-2 bg-primary-blue rounded-lg cursor-pointer'
              />
